            ...
            {items.map((item) => (
              <div key={item.id} className="card flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600">₹{item.price}/monthly</p>
                </div>
                ...
                <div className="text-right">
                  <p className="font-semibold">₹{(item.tenureMonths ? item.price * item.tenureMonths * item.quantity : item.price * item.quantity * (item.rentalDays || 1)).toFixed(0)}</p>
                  <button
